 ...
 */
final class Version20211021135144 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, leader_id INT NOT NULL, semester_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, ects SMALLINT NOT NULL, INDEX IDX_C24262873154ED4 (leader_id), INDEX IDX_C2426284A798B6F (semester_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE semester (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, period LONGTEXT DEFAULT NULL, color_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
